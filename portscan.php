...
<form class="needs-validation" novalidate="" action="portscan.php" method="get">
        <div class="center">
          <div class="col-md-4 mb-1">
            <label for="firstName">IP-Address</label>
            <input type="text" class="form-control" id="pings" name="portscan" placeholder="" value="" required="">
